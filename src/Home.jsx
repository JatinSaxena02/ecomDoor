    ...
    <>
      <section id="homesection1">
        <div className="mt-2 HS1-div-img">
          ...
          <NavLink to="/" className="HS1imgbtn">
            For Her
          </NavLink>
        </div>
        <div className="mt-2 HS1-div-img">
        ...
        <div className="homesection21-trending-category-cards">
          ...
          <div className="container homesection21-container mb-5">
            {TrendingCategoryDetails.map((value) => {
              return (
                <>
                  <TrendingCategoryCard key={value.id} imgsrc={value.imgsrc} />
                </>
              );
            })}
          </div>
      ...
      <section id="homesection3">
        <div className="mt-2 HS3-div-img">
          <NavLink to="/service">
            <img src={homeimg11} alt="img" />
          </NavLink>
          <div className="HS3heading-button-div">
            <p className="HS3heading HS3-heading-hover">
              winter wear essential
            </p>
            <NavLink to="/" className="HS3imgbtn">
              For Her
            </NavLink>
          </div>
        </div>
        ...
        <div className="homesection31-trending-category-cards">
          ...
          <div className="container homesection31-container mb-5">
            {TrendingCategoryDetails1.map((value) => {
              return (
                <>
                  <TrendingCategoryCard1 key={value.id} imgsrc={value.imgsrc} />
                </>
              );
            })}
          </div>
        ...
        <div className="homesection4-trending-category-cards">
          ...
          <div className="container homesection4-container mb-5">
            {TrendingCategoryDetails2.map((value) => {
              return (
                <>
                  <TrendingCategoryCard2 key={value.id} imgsrc={value.imgsrc} />
                </>
              );
            })}
          </div>
      ...
      <section id="homesection41">
        <div className="col-12 mt-2 mb-5">
          <div className="container-img gy-5">
            <NavLink to="/">
              <img src={TrendingCategoryImg2.homeimg37} alt="img"></img>
            </NavLink>
          </div>
        </div>
      </section>
